...
const UserDetails = ({ onComplete }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onComplete(); // Callback to notify parent component of completion
    } catch (error) {
  ...
  return (
    <form className="complete-user-detailform" onSubmit={handleSubmit}>
          ...
          <div className="avatar-img-row">
            <div
              className={`avatar-img-container ${
                isAvatarSelected(avatar1) ? "selected" : ""
              }`}
            >
              <img
                src={avatar1}
            ...
            <div
              className={`avatar-img-container ${
                isAvatarSelected(avatar2) ? "selected" : ""
              }`}
            >
              <img
                src={avatar2}
      ...
      <button className="btn-squared complete-user-btn" type="submit">
        That&apos;s me!
      </button>
    </form>
  );
