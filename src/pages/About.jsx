<section className="frontpage-about">
    ...
    <p className="frontpage-about-text">
        It’s not just about numbers though; it’s about appreciation. You get to see your own stats and costs, and even compare them with your partner’s. Think of it as a fun and eye-opening way to acknowledge each other's contributions at home.
    ...
    <p className="frontpage-about-text">
        ...
        Our goal? To nudge couples towards a happy, 50/50 balance in their domestic life. CleanSweep isn't just an app; it's your partner in fostering great conversations and a harmonious home. Let's make those unseen efforts seen and celebrated!</p>
</section>